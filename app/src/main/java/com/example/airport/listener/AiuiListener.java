...
import com.example.airport.modle.xf.Answer;
import com.example.airport.modle.xf.Content;
import com.example.airport.modle.xf.Data;
import com.example.airport.modle.xf.XInfo;
...
import com.example.airport.modle.xf.service.Translation;
import com.example.airport.modle.xf.service.Weather;
import com.example.airport.modle.xf.service.cmd.Cmd;
...
import com.example.airport.modle.xf.service.music.MusicX;
import com.example.airport.modle.xf.service.music.Semantic;
    ...
    public void onEvent(AIUIEvent event) {
        switch (event.eventType) {
            ...
            case AIUIConstant.EVENT_SLEEP:
                Log.e("GG", "休眠事件。当出现交互超时，服务会进入休眠状态（待唤醒），或者发送了");
                break;
                    ...
                    if (service.equals("weather")) {
                        ...
                        if (musicX != null) {
                            ...
                            if (semantics != null && semantics.size() > 0) {
                                ...
                                List<com.example.airport.modle.xf.service.music.Slots> slotses = semantic.getSlots();
            ...
            case AIUIConstant.EVENT_ERROR:
                Log.e("GG", "on event: " + event.eventType + " info : " + event.info);
                if (aiListener != null) {
                    aiListener.onError();
                }
                break;

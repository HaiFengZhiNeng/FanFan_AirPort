...
public class AirQueryDao extends AbstractDao<AirQuery, Long> {
    ...
    public static class Properties {
        ...
        public final static Property AirActualArriveTime = new Property(6, String.class, "airActualArriveTime", false, "AIR_ACTUAL_ARRIVE_TIME");
        public final static Property AirArrive = new Property(7, String.class, "airArrive", false, "AIR_ARRIVE");
        public final static Property AirOnTime = new Property(8, String.class, "airOnTime", false, "AIR_ON_TIME");
        public final static Property AirStatus = new Property(9, String.class, "airStatus", false, "AIR_STATUS");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"AIR_QUERY\" (" + //
                ...
                "\"AIR_ACTUAL_ARRIVE_TIME\" TEXT," + // 6: airActualArriveTime
                "\"AIR_ARRIVE\" TEXT," + // 7: airArrive
                "\"AIR_ON_TIME\" TEXT," + // 8: airOnTime
                "\"AIR_STATUS\" TEXT);"); // 9: airStatus
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, AirQuery entity) {
        ...
        String airActualArriveTime = entity.getAirActualArriveTime();
        if (airActualArriveTime != null) {
            stmt.bindString(7, airActualArriveTime);
        }
 
        String airArrive = entity.getAirArrive();
        if (airArrive != null) {
            stmt.bindString(8, airArrive);
        }
 
        String airOnTime = entity.getAirOnTime();
        if (airOnTime != null) {
            stmt.bindString(9, airOnTime);
        }
 
        String airStatus = entity.getAirStatus();
        if (airStatus != null) {
            stmt.bindString(10, airStatus);
        }
    }
    ...
    public AirQuery readEntity(Cursor cursor, int offset) {
        AirQuery entity = new AirQuery( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // airActualArriveTime
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // airArrive
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), // airOnTime
            cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9) // airStatus
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, AirQuery entity, int offset) {
        ...
        entity.setAirActualArriveTime(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setAirArrive(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
        entity.setAirOnTime(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
        entity.setAirStatus(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
     }

package com.example.airport.database.citySelect;
...
/**
 * @author Joshua 用法： CityDBHelper dbHelper = new CityDBHelper(this);
...
public class CityDBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.example.airport/databases/";
    /*

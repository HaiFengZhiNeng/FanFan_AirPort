package com.example.airport.database.base;
...
import com.example.airport.database.DaoMaster;
import com.example.airport.database.DaoSession;
import com.example.airport.database.interfaces.IDataBase;
...
public abstract class BaseManager<M, K> implements IDataBase<M, K> {
    ...
    public static final String DEFAULT_DATABASE_NAME = "airport.db";
